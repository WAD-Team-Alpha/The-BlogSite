import { Facebook, GitHub, Instagram, KeyboardArrowUp, Twitter, WhatsApp, YouTube } from '@mui/icons-material'
        ...
        <>
            <div className={"container-fluid " + classes.upstream}>
                ...
                <button className={'btn shadow-none ' + classes.upbutton}>
                    <KeyboardArrowUp sx={{ fontSize: '2em', padding: '0', marginTop: '-0.25em' }} />
                </button>
            </div>
            <div className={"container-fluid " + classes.content}>
                <div className={"container-fluid " + classes.line1}>
                    ...
                    <button className={"btn shadow-none " + classes.support}>Support us</button>
                </div>
