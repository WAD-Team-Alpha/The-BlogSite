      ...
      >
        <div className="row">
          ...
          <div className={"col-md-6 " + classes.content}>
            ...
            <p>
              Search various answered questions and share your thoughts on
      ...
      >
        <div className="row">
          <div className={"col-md-6 " + classes.content}>
            ...
            <p>
              Got something on your mind? Well share them with others and grow
              your followers. You can create posts that interests other users.
            </p>
          </div>
          <div className="col-md-3"></div>
          <div className="col-md-3">
      ...
      >
        <div className="row">
          ...
          <div className={"col-md-6 " + classes.content}>
            ...
            <p>
              Know someone? Search them and follow them to recieve notifications
              for their content and other updates about them.
            </p>
          </div>
        </div>
      </motion.div>
