  ...
  return (
    ...
    >
      <div className={classes.header}>
        <button
          type="button"
          className={"btn btn-primary shadow-none " + classes.menubutton}
          onClick={props.nav}
        >
      ...
      <div className={"container " + classes.content}>
        ...
        <p>
          Creativity doesn't wait for that perfect moment. Publish your
          passions, your own way.
        </p>
        <Link
          to={path}
          className={"btn btn-primary shadow-none " + classes.postbutton}
        >
