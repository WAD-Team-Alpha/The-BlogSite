          ...
          <form onSubmit={formSubmitHandler}>
            <div className="row">
              <div className="col-md-6">
                <div
                  className={`mb-3 ${
                    state.firstNameIsEmpty === true ? classes.invalid : ""
                  } ${state.firstNameIsEmpty === false ? classes.valid : ""}`}
                >
                  <input
                    type="text"
              ...
              <div className="col-md-6">
                <div
                  className={`mb-3 ${
                    state.lastNameIsEmpty === true ? classes.invalid : ""
                  } ${state.lastNameIsEmpty === false ? classes.valid : ""}`}
                >
                  <input
                    type="text"
                    className="form-control"
              ...
              >
                ...
                {state.passwordIsValid === false && (
                  <span style={{ fontSize: "0.8em", color: "red" }}>
                    Password should be minimum 6 charachters and it should
                    contain atleast 1 uppercase, 1 lowercase, 1 number and 1
                    special charachter
                  </span>
                )}
              </div>
              <div
                className={`input-group mb-3 ${
                  state.passwordIsMatching === false ? classes.invalid : ""
                } ${state.passwordIsMatching === true ? classes.valid : ""} `}
              >
                <input
                  type={showPass ? "text" : "password"}
                  className="form-control"
